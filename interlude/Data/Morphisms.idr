{-
  This is the exact same file as https://github.com/idris-lang/Idris2/blob/master/libs/base/Data/Morphisms.idr,
  except (~>) is exported publicly so that the type checker knows that Mor makes a (~>).
  We also make Kleislimorphism implement Alternative, and Morphism and Kleislimorphism implement Category.
-}
...
public export
Alternative m => Alternative (Kleislimorphism m a) where
