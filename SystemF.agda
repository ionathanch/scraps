...
termrel : ∀ {Δ Γ ℓ} (η₁ η₂ : TEnv Δ) (ρ : RTEnv Δ η₁ η₂) (δ₁ : Env Γ η₁) (δ₂ : Env Γ η₂) (A : Type Δ ℓ) (a : Term Δ Γ A) →
          REnv η₁ η₂ ρ δ₁ δ₂ → typerel η₁ η₂ ρ A (⟦ a ⟧ η₁ δ₁) (⟦ a ⟧ η₂ δ₂)
termrel η₁ η₂ ρ δ₁ δ₂ _ (var where?) ζ = ζ where?
termrel η₁ η₂ ρ δ₁ δ₂ _ (λ′ b) ζ a₁ a₂ Ra = termrel η₁ η₂ ρ (extend δ₁ a₁) (extend δ₂ a₂) _ b (extendᴿ ζ Ra)
termrel η₁ η₂ ρ δ₁ δ₂ _ ($′ b a) ζ = termrel η₁ η₂ ρ δ₁ δ₂ _ b ζ (⟦ a ⟧ η₁ δ₁) (⟦ a ⟧ η₂ δ₂) (termrel η₁ η₂ ρ δ₁ δ₂ _ a ζ)
termrel η₁ η₂ ρ δ₁ δ₂ _ (Λ {ℓ} b) ζ A₁ A₂ R =
  termrel (cons {ℓ = ℓ} η₁ A₁) (cons {ℓ = ℓ} η₂ A₂) (consᴿ ρ R) (extend′ η₁ δ₁ A₁) (extend′ η₂ δ₂ A₂) _ b (extendᴿ′ ζ)
termrel η₁ η₂ ρ δ₁ δ₂ _ ($ b A) ζ =
  let ⟦b⟧A = termrel η₁ η₂ ρ δ₁ δ₂ _ b ζ (⟦ A ⟧′ η₁) (⟦ A ⟧′ η₂) (typerel η₁ η₂ ρ A)
